...
public class entry_1524197 extends PrintStream {
...
//  InputReader sc = new InputReader(new FileInputStream("test_input.txt"));
  entry_1524197() { super(System.out); }
    ...
    public static void main(String[] $) {
        new Thread(null, new Runnable() {
            public void run() {
                ...
                try {entry_1524197 solution = new entry_1524197(); solution.solve(); solution.flush();} 
