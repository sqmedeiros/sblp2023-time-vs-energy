...
#define CHRONO_TEST 0
 
int64_t A[200001];
int64_t P[200001];
 
void scanint(int64_t &x)
{
...
int main()
{
    ...
    //freopen("C:\\Users\\q464219\\Desktop\\input.txt", "r", stdin);
 
    // Printing the Output to output.txt file
    //freopen("C:\\Users\\q464219\\Desktop\\output.txt", "w", stdout);
#if CHRONO_TEST
    ...
    int64_t i = n;
    while (i) {scanint(P[i]); --i;}
    i = m;
    while (i) {scanint(A[i]); --i;}
    ...
    pdqsort(A + 1, A + m + 1, greater<int64_t>());
    pdqsort(P + 1, P + n + 1, greater<int64_t>());
